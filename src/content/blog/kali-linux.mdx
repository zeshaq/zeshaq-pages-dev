...
export const phaseStyle = { background: "#e5e7eb", border: "1px solid #6b7280", borderRadius: 8, padding: 10, color: "#1f2937", width: 160, textAlign: "center", fontWeight: 600, fontSize: 12 };
export const phaseEdge = { style: { stroke: "#1f2937", strokeWidth: 1.5 }, markerEnd: { type: "arrowclosed", color: "#1f2937" } };

export const killchainNodes = [
  { id: "recon",   position: { x: 40,   y: 100 }, data: { label: "Recon" },                  style: phaseStyle },
  { id: "scan",    position: { x: 230,  y: 100 }, data: { label: "Scan + enum" },             style: phaseStyle },
  { id: "exploit", position: { x: 420,  y: 100 }, data: { label: "Exploit / initial access" }, style: phaseStyle },
  { id: "post",    position: { x: 610,  y: 100 }, data: { label: "Post-exploit" },            style: phaseStyle },
  { id: "lateral", position: { x: 800,  y: 100 }, data: { label: "Lateral movement" },        style: phaseStyle },
  { id: "exfil",   position: { x: 990,  y: 100 }, data: { label: "Exfil / impact" },          style: phaseStyle },
];

export const killchainEdges = [
  { id: "k1", source: "recon",   target: "scan",    ...phaseEdge },
  { id: "k2", source: "scan",    target: "exploit", ...phaseEdge },
  { id: "k3", source: "exploit", target: "post",    ...phaseEdge },
  { id: "k4", source: "post",    target: "lateral", ...phaseEdge },
  { id: "k5", source: "lateral", target: "exfil",   ...phaseEdge },
];
...
<Whiteboard client:load data={{ nodes: killchainNodes, edges: killchainEdges }} height={250} />
