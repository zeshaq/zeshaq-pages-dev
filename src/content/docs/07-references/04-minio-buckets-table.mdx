...
| --- | --- | --- |
| `developer-ci-evidence` writer | local file at `/home/ze/codex-opp-agent/secrets/minio-developer-ci-evidence.env` | `connection-details/minio.md` |
| `developer-ci-evidence` reader | local file at `/home/ze/codex-opp-agent/secrets/minio-developer-ci-evidence-reader.env` | `connection-details/minio.md` |
