...
| ADR | Architecture Decision Record | Lab convention: numbered `.md` file capturing a decision. | `codex-opp-agent/adr/` |
...
- `codex-opp-agent/adr/` (decision history)
- `codex-opp-agent/connection-details/` (per-service operator detail)
