...
# e.g.
/home/ze/claude-agent/scripts/vault-apps-onboard.sh platform spoke-dc-v6
```
...
- `codex-opp-agent/connection-details/vault-app-secrets.md` (issue #174, DEV-OCP-0.4)
- `codex-opp-agent/connection-details/app-registry-pullsecret.md` (issue #172, DEV-OCP-0.2)
