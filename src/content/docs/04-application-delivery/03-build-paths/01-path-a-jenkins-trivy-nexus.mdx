...
All credentials referenced below live in the Jenkins credential store at `https://jenkins.apps.sub.comptech-lab.com/credentials/`. Local custody copies live under `/home/ze/codex-opp-agent/secrets/jenkins/` (Git-ignored). Do not paste values into this file, into tickets, or into chat.
