...
The script lives at [`ops-workspace/scripts/update-overlay-digest.sh`](https://github.com/zeshaq/ops-workspace/blob/main/scripts/update-overlay-digest.sh). It is idempotent: running it twice with the same digest produces no second commit.
