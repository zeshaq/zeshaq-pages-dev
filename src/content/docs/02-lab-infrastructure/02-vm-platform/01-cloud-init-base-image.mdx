...
1. **Allocate** an IP and MAC by editing `plans/disconnected-rebuild/environments/dc-lab/allocation-table.md`. The deterministic MAC convention is `52:54:00:XX:XX:<last-octet-of-IP-in-hex>`; the exact middle bytes are part of the internal lab convention recorded in `codex-opp-agent/connection-details/`. This makes the allocation table greppable.
