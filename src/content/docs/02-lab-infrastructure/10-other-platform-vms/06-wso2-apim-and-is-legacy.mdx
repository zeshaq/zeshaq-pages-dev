...
The full runbook lives at `codex-opp-agent/runbooks/wso2-apim-jms-url-encoding-trap.md` with pre-action checks, validation criteria, and a worked example.
...
- `codex-opp-agent/adr/0008-wso2-apim-is-standalone-vms.md` — VM design and HAProxy hostname pattern.
- `codex-opp-agent/runbooks/wso2-apim-jms-url-encoding-trap.md` — JMS URL-encoding trap full runbook.
