...
- `codex-opp-agent/adr/0015-federated-gitops-repo-architecture.md` — parent architecture.
- `codex-opp-agent/adr/0016-workspace-execution-governance.md` — operator workspace rules.
- `codex-opp-agent/connection-details/gitlab-operator-guide.md` — operator runbook.
- `codex-opp-agent/plans/federated-gitops-gitlab-access-matrix.md` — full access matrix (the source-of-truth design baseline).
- `codex-opp-agent/plans/federated-gitops-gitlab-implementation-checklist.md` — execution sequence.
