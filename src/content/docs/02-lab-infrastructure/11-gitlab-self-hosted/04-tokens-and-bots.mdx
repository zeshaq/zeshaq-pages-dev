...
- `codex-opp-agent/connection-details/gitlab-operator-guide.md` — secret and variable policy.
- `codex-opp-agent/adr/0023-federated-gitlab-group-repo-ownership.md` — ownership boundary the tokens enforce.
- [Protected runner model](./03-protected-runner-model) — runner-token specifics.
- `codex-opp-agent/runbooks/secrets-custody-drift-check.md` — periodic drift check across credential custody.
