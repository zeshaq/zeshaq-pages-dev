...
- `codex-opp-agent/connection-details/jenkins.md` — current service, agent details, validation.
- `codex-opp-agent/adr/0009-jenkins-single-vm.md` — single-VM controller decision.
- `codex-opp-agent/runbooks/jenkins-gitlab-webhook-pollscm.md` — Pipeline trigger gotcha (relevant because misconfigured triggers re-route to controller).
