...
- `codex-opp-agent/adr/0011-trivy-ubuntu-vm-scanner.md` — VM design and guardrails.
- `codex-opp-agent/connection-details/jenkins.md` — `trivy-server-token` Jenkins credential.
