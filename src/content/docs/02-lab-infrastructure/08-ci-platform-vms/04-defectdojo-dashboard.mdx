...
- `codex-opp-agent/adr/0013-defectdojo-vm-security-dashboard.md` — VM decision and override list.
- `codex-opp-agent/adr/0011-trivy-ubuntu-vm-scanner.md` — Trivy scanner, the report source.
