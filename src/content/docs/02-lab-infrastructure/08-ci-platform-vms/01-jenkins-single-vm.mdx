...
The starter Pipeline template lives at `codex-opp-agent/examples/jenkins/Jenkinsfile.nexus-app` and is the recommended starting point for new app jobs.
...
- `codex-opp-agent/connection-details/jenkins.md` — current service, credentials, validation.
- `codex-opp-agent/adr/0009-jenkins-single-vm.md` — single-VM decision.
- `codex-opp-agent/runbooks/jenkins-gitlab-webhook-pollscm.md` — webhook setup gotcha.
- `codex-opp-agent/examples/jenkins/Jenkinsfile.nexus-app` — starter pipeline template.
