...
export const mirrorNodes = [
  { id: "upstream", position: { x: 0,   y: 30 }, data: { label: "Upstream registries\nregistry.redhat.io\nicr.io / quay.io" }, style: ext },
  { id: "nexus",    position: { x: 220, y: 30 }, data: { label: "Nexus VM\nocp-mirror hosted\nport 5000" }, style: ctrl },
  { id: "edge",     position: { x: 440, y: 30 }, data: { label: "mirror-registry.apps.\nsub.comptech-lab.com\n(HAProxy 443)" }, style: ctrl },
  { id: "ocp",      position: { x: 660, y: 30 }, data: { label: "OpenShift cluster nodes\nhub-dc-v6, spoke-dc-v6" }, style: stage },
];

export const mirrorEdges = [
  { id: "e1", source: "upstream", target: "nexus", label: "oc mirror --v2\nfrom bootstrap host", ...reqEdge },
  { id: "e2", source: "nexus",    target: "edge",  label: "HAProxy 443 + LE wildcard", ...reqEdge },
  { id: "e3", source: "edge",     target: "ocp",   label: "pull by digest\nIDMS / ITMS rewrites", ...reqEdge },
];
...
<Whiteboard client:load data={{ nodes: mirrorNodes, edges: mirrorEdges }} height={220} />
