...
- `codex-opp-agent/connection-details/jenkins.md` — `trivy-server-token`, starter-job evidence.
- `codex-opp-agent/connection-details/nexus.md` — push contract on `app-registry`.
- `codex-opp-agent/connection-details/ci-evidence-schema.md` — evidence layout for MinIO.
- `codex-opp-agent/adr/0011-trivy-ubuntu-vm-scanner.md` — Trivy VM design.
- `codex-opp-agent/adr/0013-defectdojo-vm-security-dashboard.md` — DefectDojo placement.
