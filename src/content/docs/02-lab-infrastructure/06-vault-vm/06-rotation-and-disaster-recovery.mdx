...
- HashiCorp Raft snapshot: [developer.hashicorp.com](https://developer.hashicorp.com/vault/docs/commands/operator/raft#snapshot)
- HashiCorp seal/rekey: [developer.hashicorp.com/vault/docs/commands/operator/rekey](https://developer.hashicorp.com/vault/docs/commands/operator/rekey)
