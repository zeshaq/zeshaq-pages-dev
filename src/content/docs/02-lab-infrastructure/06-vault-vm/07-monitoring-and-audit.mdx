...
- HashiCorp audit devices: <https://developer.hashicorp.com/vault/docs/audit>
- HashiCorp Telemetry / Prometheus: <https://developer.hashicorp.com/vault/docs/internals/telemetry>
- HashiCorp Raft Autopilot: <https://developer.hashicorp.com/vault/docs/concepts/integrated-storage/autopilot>
