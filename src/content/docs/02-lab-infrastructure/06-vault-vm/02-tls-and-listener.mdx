...
- HashiCorp Vault listener docs: [developer.hashicorp.com](https://developer.hashicorp.com/vault/docs/configuration/listener/tcp)
- HashiCorp Vault production-hardening: [developer.hashicorp.com](https://developer.hashicorp.com/vault/docs/concepts/production-hardening)
