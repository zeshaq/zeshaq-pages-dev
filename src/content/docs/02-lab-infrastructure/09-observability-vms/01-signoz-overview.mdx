...
- `codex-opp-agent/connection-details/signoz.md` — runbook for the live service.
- `codex-opp-agent/adr/0010-signoz-standalone-vm-observability.md` — VM design decision.
- Memory: `reference_lab_infrastructure.md` — two-VM observability split, port collision warning.
