...
6. **Store credentials.** Local-only ignored custody under `codex-opp-agent/secrets/minio/<service>-<cluster>.env`:
...
The published lab docs do **not** include any MinIO credentials. The connection-details file at `codex-opp-agent/connection-details/minio.md` documents the existence and location of custody, never the values.
