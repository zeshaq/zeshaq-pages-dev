---
title: "Installation Manual - 04 Vault installation"
sidebar_label: "04 Vault installation"
...
Vault is the greenfield secret broker. It is installed after GitLab, DNS, HAProxy, and private VM egress because later services need a controlled place for credentials, tokens, bootstrap material, and future OpenShift External Secrets Operator integration.
...
- Raft snapshot backup to MinIO is not configured yet.
