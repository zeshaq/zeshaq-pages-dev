...
Before the production operator mirror, pre-create repositories from the
oc-mirror dry-run mapping and grant the mirror robot write access:
...
- Pre-seed operator repositories from the oc-mirror dry-run mapping before the
  long production operator mirror.
