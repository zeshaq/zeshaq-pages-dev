...
- The certificate is the shared Let's Encrypt wildcard certificate
  `*.v7.comptech-lab.com`, issued with DNS-01 against the delegated
  `v7.comptech-lab.com` PowerDNS zone.
