---
title: "Installation Manual — 02 HAProxy installation"
sidebar_label: "02 HAProxy installation"
...
HAProxy is the second greenfield foundation service after PowerDNS. It provides the first stable edge endpoint for the platform while later services are built behind it.
