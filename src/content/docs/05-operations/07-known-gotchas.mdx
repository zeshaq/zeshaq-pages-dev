...
1. If it cost more than an hour or has architectural implications, it gets a runbook under `opp-full-plat/runbooks/` and a published incident page on this site.
...
- Runbooks (all `opp-full-plat/runbooks/`):
...
- Connection-details docs:
  ...
  - `opp-full-plat/connection-details/signoz.md` §"Known Gotchas"
