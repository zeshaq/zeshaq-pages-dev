...
11. The new cluster's kubeadmin password has been copied to `secrets/<new-cluster>-kubeadmin-password` (filesystem-only).
...
- `codex-opp-agent/connection-details/platform-admin-handoff.md` §"GitOps Source Of Truth"
- `codex-opp-agent/connection-details/openshift-hub-dc-v6.md`, `openshift-spoke-dc-v6.md`
- Memory: `reference_spoke_argo_extension_rbac`, `reference_rhacs_init_bundle_via_api`, `project_eso_egress_to_vault`
