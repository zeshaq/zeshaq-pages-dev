...
- `codex-opp-agent/connection-details/compliance-implementor-handbook.md` (the PCI-DSS phase chain — example of multi-policy rollout)
- `codex-opp-agent/connection-details/vap-tenant-exclusions.md` (the adjacent VAP surface)
