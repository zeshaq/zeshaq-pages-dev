...
- Runbook: `codex-opp-agent/runbooks/wso2-apim-jms-url-encoding-trap.md`
- Runbook: `codex-opp-agent/runbooks/secrets-custody-drift-check.md` (the prior check that surfaces the stale password before this trap fires)
- `codex-opp-agent/connection-details/` — WSO2 endpoint and port details
