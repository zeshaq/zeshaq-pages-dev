...
Edit `codex-opp-agent/plans/disconnected-rebuild/environments/dc-lab/operator-version-lock.md` to reflect the new target version. Open the tracking issue. Cite ADRs (0019 for pinning, 0025 for GitOps-only operations, 0018 for the pull model — whichever apply).
...
- `codex-opp-agent/plans/disconnected-rebuild/environments/dc-lab/operator-version-lock.md` — canonical version table.
