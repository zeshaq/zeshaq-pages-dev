...
- `project_obc_to_operand_secret_bridge.md` (memory) — the canonical pattern reference.
- `connection-details/platform-admin-handoff.md` — operator versions for ODF/Loki/Tempo/Quay.
