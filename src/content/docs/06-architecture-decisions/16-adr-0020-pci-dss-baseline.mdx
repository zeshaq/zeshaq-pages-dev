...
The compliance implementor handbook (`codex-opp-agent/connection-details/compliance-implementor-handbook.md`, issue #130) is the operator's runbook for executing PCI-0 → PCI-5. It pairs with `platform-admin-handoff.md` and `gitlab-operator-guide.md`. This ADR sets the rules; the handbook says how to follow them.

## References

- Source: `codex-opp-agent/adr/0020-pci-dss-profile-compliance-spoke-dc-v6.md`
...
- IPv6 on OVN-K: `codex-opp-agent/adr/0026-ipv6-baseline-for-ovn-kubernetes.md`
- v6 fleet membership: [ADR 0022](/docs/06-architecture-decisions/17-adr-0022-v6-fleet-purge)
- Compliance implementor handbook: `codex-opp-agent/connection-details/compliance-implementor-handbook.md`
