...
- Source: `codex-opp-agent/adr/0010-signoz-standalone-vm-observability.md`
...
- SigNoz operator notes: `codex-opp-agent/connection-details/signoz.md`
- GitHub milestone: `zeshaq/codex-opp-agent` #17
