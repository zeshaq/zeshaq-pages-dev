...
VM allocations are deterministic and recorded in the WSO2 VM plan before VM creation (specific IPs and MAC addresses kept in `codex-opp-agent/connection-details/` because they are internal-only). The intended public DNS names are:
...
- Source: `codex-opp-agent/adr/0008-wso2-apim-is-standalone-vms.md`
