...
- Source: `codex-opp-agent/adr/0013-defectdojo-vm-security-dashboard.md`
- Trivy scanner ADR: `codex-opp-agent/adr/0011-trivy-ubuntu-vm-scanner.md`
- Edge wiring rules: [ADR 0005](/docs/06-architecture-decisions/05-adr-0005-network-ingress-pki)
- RHACS integration context: `codex-opp-agent/connection-details/rhacs-app-policy.md`
- GitHub milestone: `zeshaq/codex-opp-agent` #21
