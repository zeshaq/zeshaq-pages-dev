...
Superseded by [Blog ADR 0007](./07-adr-0007-docs-master-section) on 2026-05-12. The `brac-poc` collection was folded back under `/docs/` as a sub-module (`/docs/brac-poc/`) when the broader docs IA was reorganised around master sections. The audience-separation problem this ADR addressed is now solved by the docs sidebar's per-module scoping instead of a separate collection.
