...
description: "Why this lab keeps a single local operator workspace under /home/ze/opp-full-plat that ties together live state, desired state, secrets, ADRs, and session reports."
...
- Source: `opp-full-plat/adr/0001-operator-workspace.md`
