...
| [REP-2.1 #241](https://github.com/zeshaq/opp-full-plat/issues/241) — parameterize remaining docs | OPEN | RUNBOOK.md + remaining `connection-details/` |
| [REP-2.2 #243](https://github.com/zeshaq/opp-full-plat/issues/243) — unify the two profile.yaml files | **CLOSED** | Single canonical profile at `environments/<site>/profile.yaml`; schema doc updated |
| [REP-3 #147](https://github.com/zeshaq/opp-full-plat/issues/147) — GitLab content bootstrap | OPEN (Phase 1) | `plans/disconnected-rebuild/gitlab-bootstrap-design.md` + `terraform/gitlab-bootstrap/` + `scripts/gitlab/render-codeowners.py` |
| [REP-3.2/3.3/3.4 #235/#236/#237](https://github.com/zeshaq/opp-full-plat/issues/235) | OPEN | Role groups + shares + branch protection / runner registration / full repo seeding |
...
| [REP-4.2 #244](https://github.com/zeshaq/opp-full-plat/issues/244) — refactor remaining ~22 scripts | OPEN | n/a (large mechanical pass) |
...
| [REP-5.2/3/4/5 #238/#239/#240/#242](https://github.com/zeshaq/opp-full-plat/issues/238) | OPEN | L0-L7 / PCI / FG+DH chains + GitHub Projects v2 GraphQL |
...
- [REP-3.2 #235](https://github.com/zeshaq/opp-full-plat/issues/235) — role groups + project shares + branch protection via Terraform.
- [REP-3.3 #236](https://github.com/zeshaq/opp-full-plat/issues/236) — runner registration token generation + Vault storage.
- [REP-3.4 #237](https://github.com/zeshaq/opp-full-plat/issues/237) — full repo seeding (infra-ops, platform-services, tenant-registry, divisions).
...
Smoke test `scripts/rebuild/lib/test-profile-lib.sh` passes 11/11. The remaining ~22 scripts are tracked under [REP-4.2 #244](https://github.com/zeshaq/opp-full-plat/issues/244) as a mechanical pass.
...
- [REP-5.2 #238](https://github.com/zeshaq/opp-full-plat/issues/238) — L0-L7 chain templates.
- [REP-5.3 #239](https://github.com/zeshaq/opp-full-plat/issues/239) — PCI-0..PCI-5 chain templates.
- [REP-5.4 #240](https://github.com/zeshaq/opp-full-plat/issues/240) — FG-0..FG-6 + DH chain templates.
- [REP-5.5 #242](https://github.com/zeshaq/opp-full-plat/issues/242) — GitHub Projects v2 GraphQL integration.
