...
Per [issue #198 (DEV-OCP-4.3)](https://github.com/zeshaq/opp-full-plat/issues/198).
...
Per [`vap-tenant-exclusions.md`](../05-platform-controls/02-image-registry-allowlist) and [`vap-tenant-exclusions.md`](https://github.com/zeshaq/opp-full-plat/blob/main/connection-details/vap-tenant-exclusions.md): **there is no clean per-tenant VAP bypass.** VAPs aggregate by AND. Tenant exceptions to the cluster-wide allowed-image-registries VAP go through one of two paths:
