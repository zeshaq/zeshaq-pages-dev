...
- [02-version-pinning-strategy](/docs/openshift-platform/openshift-platform/operator-lifecycle/version-pinning-strategy) — the pinning rules an upgrade temporarily breaks.
- [04-operatorpolicy-via-acm](/docs/openshift-platform/openshift-platform/operator-lifecycle/operatorpolicy-via-acm) — what governance reports during the upgrade window.
- [02-oc-mirror-workflow](/docs/openshift-platform/openshift-platform/disconnected-image-supply/oc-mirror-workflow) — the mirror side of the upgrade.
- [03-idms-itms-and-cluster-pull](/docs/openshift-platform/openshift-platform/disconnected-image-supply/idms-itms-and-cluster-pull) — IDMS regeneration after a catalog change.
