...
- `brac-demo-jboss` — planned JBoss EAP managed-domain demo (separate from mesh services). For the delivered bank-employees chat implementation, see [JBoss Chat app](/docs/brac-poc/jboss-chat/).
