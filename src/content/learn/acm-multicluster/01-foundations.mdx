...
The lab uses the pull model for OpenShift GitOps fan-out — see [ADR 0018 — ACM + OpenShift GitOps pull model](/docs/openshift-platform/architecture-decisions/adr-0018-acm-gitops-pull) and the broader [pull-model GitOps decision in ADR 0019](/docs/openshift-platform/architecture-decisions/adr-0019-pull-model-gitops). Almost every example in this track assumes pull.
