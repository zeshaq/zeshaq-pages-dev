...
- Seven containers running on one VM: Liberty, MI, Postgres, SigNoz (a few sub-containers), Redis, Kafka, WSO2 IS, WSO2 APIM.

Module 13 closes the track.

Next: [13 — What's next →](/learn/openliberty/whats-next)
