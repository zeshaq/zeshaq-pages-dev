...
**Next:** [Module 06 — Training Operators](/learn/kubeflow/training-operators) — distributed training via `PyTorchJob`, `TFJob`, `MPIJob`, gang scheduling, elastic training, and the patterns for surviving spot-node preemption.
