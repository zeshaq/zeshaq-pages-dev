...
description: "Build the ACI Simulator access policy chain for Lab 1 EPGs using VLAN pool, physical domain, AEP, access port policy group, and static path bindings."
